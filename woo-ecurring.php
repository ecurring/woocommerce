...
<?php
                ...
                add_action(
                    ...
                    function () {
                        ...
                        register_setting('ecurring-settings-group', 'ecurring_customer_subscription_switch');
                        register_setting('ecurring-settings-group', 'ecurring_customer_subscription_cancel');
                    }
                );
            }
        );
